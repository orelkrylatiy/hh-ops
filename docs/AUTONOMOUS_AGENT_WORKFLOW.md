...
Термин **hot lead** в этом проекте имеет строгое значение из
[HOT_LEADS.md](HOT_LEADS.md): вероятный живой рекрутер/нанимающий менеджер плюс
конкретный переход к созвону, интервью, встрече или личному контакту. Агент не
должен повышать обычные acknowledgements, robot recruiter flows, тестовые или
скрининговые вопросы до hot lead только из-за позитивной формулировки.
